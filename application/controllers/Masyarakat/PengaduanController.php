...
class PengaduanController extends CI_Controller
{
	...
	public function dashboard_masyarakat()
	{
		...
		$data['pengaduan'] = $this->Pengaduan_m->data_pengaduan_masyarakat_nik($masyarakat['nik'])->num_rows();
		$data['pengaduan_selesai'] = $this->Pengaduan_m->data_pengaduan_masyarakat_nik_selesai($masyarakat['nik'])->num_rows();
		$data['pengaduan_tolak'] = $this->Pengaduan_m->data_pengaduan_masyarakat_nik_tolak($masyarakat['nik'])->num_rows();
	...
	public function pengaduan_detail($id)
	{
		...
		if (!empty($cek_data)) :
			...
			$data['title'] = 'Siaduin | Detail Pengaduan';
	...
	public function edit($id)
	{
		...
		if (!empty($cek_data)) :
			...
			if ($cek_data['status'] == '0') :
				...
				$data['title'] = 'Siaduin | Edit Pengaduan';
