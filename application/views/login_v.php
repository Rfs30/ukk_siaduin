            ...
            <div class="col-lg-12">
              <div class="p-5">
                <div class="text-center">
                  <img src="<?php echo base_url(); ?>assets/img/logo_rfs.png" class="img-responsive" alt="responsive image" width="300">
                ...
                <hr>
                <div class="text-center">
                  <a class="small" href="<?= base_url('landing') ?>">Kembali</a>
                  <center>
                    <p>Repost By SMK SMK IGASAR PINDAD</a></p>
                  </center>
                </div>
              </div>
            </div>
