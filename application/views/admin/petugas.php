        ...
        <?php foreach ($data_petugas as $dp) : ?>
          <tr>
            ...
            <td>
              ...
              <?php else : ?>
                <a href="<?= base_url('Admin/Petugas/edit/' . $dp['id_petugas']) ?>" class="btn btn-info">Edit</a>
                <a href="<?= base_url('Admin/Petugas/delete/' . $dp['id_petugas']) ?>" class="btn btn-warning">Hapus</a>
              <?php endif; ?>
            </td>
          </tr>
        <?php endforeach; ?>
