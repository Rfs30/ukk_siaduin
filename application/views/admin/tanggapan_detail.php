...
<div class="container-fluid mb-2">
  ...
  <!-- Page Heading -->
  <a href="<?= base_url('Admin/Tanggapan') ?>" class="btn btn-dark"><i class="fas fa-arrow-left"></i></a>
  ...
  <div class="row">
    <div class="col-lg-6">
      ...
      <?= form_open('Admin/Tanggapan/tambah_tanggapan'); ?>
      ...
      <div class="form-group">
        ...
        <select name="tanggapan" class="form-control" id="tanggapan" cols="30" rows="10">
          <option>Laporan anda akan segera diproses</option>
          <option>Laporan anda belum cukup jelas dan lengkap</option>
        </select>
      </div>
